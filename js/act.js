...
(function() {
    ...
    var myLatlng = new google.maps.LatLng(39.966409, -82.968093); // Columbus
    function init() {
        ...
        var contentString = '<div id="content">' +
            ...
            '</div>' +
            '<div id="mapInfoBox">' +
            '<br><h2 id="firstHeading" class="firstHeading">Columbus Police Foundation</h2>' +
            '<h4><i class="fa fa-car text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>1234 E. Broad Street, Columbus, OH 43205</b></h4>' +
            '<h4><i class="fa fa-envelope text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>admin@thecolumbuspolicefoundation.org</b></h4>' +
            '</div>' +
            '</div>';
